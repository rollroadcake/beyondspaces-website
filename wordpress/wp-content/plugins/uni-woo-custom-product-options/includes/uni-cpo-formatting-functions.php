...
/**
 * Return proper option's label for single product page
 *
 * @param string $label
 *
 * @return string
 ...
 *
 */
function uni_cpo_get_proper_option_label_sp(  $label  ) {
    return $label;
}

/**
 * Return proper option's label for cart/order meta. Just strip '{#' and '#}'
 *
 * @param string $label
 *
 * @return string
 ...
 *
 */
function uni_cpo_get_proper_option_label_cart(  $label  ) {
    return $label;
}
