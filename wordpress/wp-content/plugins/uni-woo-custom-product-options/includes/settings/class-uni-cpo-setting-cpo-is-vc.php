...
/*
* Uni_Cpo_Setting_Cpo_Is_Vc class
*
*/
class Uni_Cpo_Setting_Cpo_Is_Vc extends Uni_Cpo_Setting implements Uni_Cpo_Setting_Interface {
    /**
     * Init
     *
     */
    public function __construct() {
        $this->setting_key = 'cpo_is_vc';
        $this->setting_data = array(
            'title'      => __( 'Enable validation logic?', 'uni-cpo' ),
            'is_tooltip' => true,
            'desc_tip'   => __( 'Enables validation conditional logic for this option.', 'uni-cpo' ),
            'options'    => array(
                'no'  => __( 'No', 'uni-cpo' ),
                'yes' => __( 'Yes', 'uni-cpo' ),
            ),
