...
/*
* Uni_Cpo_Setting_Justify_Content class
*
*/

class Uni_Cpo_Setting_Justify_Content extends Uni_Cpo_Setting implements Uni_Cpo_Setting_Interface
{
    ...
    {
        $this->setting_key = 'justify_content';
        $this->setting_data = array(
            'title' => __('Justify Content', 'uni-cpo'),
            'type' => 'text',
            'options' => array(
                'start' => __('start'),
                'end' => __('end'),
