...
/*
* Uni_Cpo_Setting_Cpo_Date_Rules class
*
*/

class Uni_Cpo_Setting_Cpo_Date_Rules extends Uni_Cpo_Setting implements Uni_Cpo_Setting_Interface {
	...
	public function __construct() {
		$this->setting_key  = 'cpo_date_rules';
		$this->setting_data = array(
			'title'      => __( 'Dates based rules', 'uni-cpo' ),
			'is_tooltip' => true,
			'is_tooltip_warning' => true,
			'desc_tip'   => __( 'These rules work in addition to "Price/Rate" setting and actually extend this setting far beyond, make it possible to apply different values based on dates/dates ranges chosen.', 'uni-cpo' ),
                                            ...
                                            <div class="uni-formula-conditional-rules-content-wrapper">
                                                <div class="uni-formula-conditional-rules-content-field-wrapper">
                                                    ...
                                                    <input id="uni_cpo_formula_rule_scheme-<%row-count%>" type="hidden"
                                                           name="<?php echo $this->setting_key ?>[<%row-count%>][rule]" value=""
                                                           class="js-sort-formula_scheme-rule"/>
                                                </div>
                                                <div class="uni-formula-conditional-rules-content-field-wrapper">
                                                    <textarea name="<?php echo $this->setting_key ?>[<%row-count%>][formula]"
                                            ...
                                            <div class="uni-formula-conditional-rules-content-wrapper">
                                                <div class="uni-formula-conditional-rules-content-field-wrapper">
                                                    ...
                                                    <input id="uni_cpo_formula_rule_scheme-{{- i }}" type="hidden"
                                                           name="<?php echo $this->setting_key ?>[{{- i }}][rule]" value="{{- obj.rule }}"
                                                           class="builderius-setting-field js-sort-formula_scheme-rule"/>
                                                </div>
                                                <div class="uni-formula-conditional-rules-content-field-wrapper">
                                                    <textarea name="<?php echo $this->setting_key ?>[{{- i }}][formula]"
