...
/*
* Uni_Cpo_Setting_Cpo_Mode_Radio class
*
*/
class Uni_Cpo_Setting_Cpo_Mode_Radio extends Uni_Cpo_Setting implements Uni_Cpo_Setting_Interface {
    /**
     * Init
     *
     */
    public function __construct() {
        $this->setting_key = 'cpo_mode_radio';
        $this->setting_data = array(
            'title'   => __( 'Type of radio input', 'uni-cpo' ),
            'options' => array(
