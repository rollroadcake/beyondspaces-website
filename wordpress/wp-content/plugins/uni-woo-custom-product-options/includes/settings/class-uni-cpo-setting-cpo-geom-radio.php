...
/*
* Uni_Cpo_Setting_Cpo_Geom_Radio class
*
*/
class Uni_Cpo_Setting_Cpo_Geom_Radio extends Uni_Cpo_Setting implements Uni_Cpo_Setting_Interface {
    /**
     * Init
     *
     */
    public function __construct() {
        $this->setting_key = 'cpo_geom_radio';
        $this->setting_data = array(
            'title'   => __( 'Style of radio input', 'uni-cpo' ),
            'options' => array(
                'square' => __( 'Square', 'uni-cpo' ),
                'circle' => __( 'Circle', 'uni-cpo' ),
            ),
            'js_var'  => 'data',
        );
