 ...
 * @since     2.1
 */
if ( ! function_exists( 'ot_register_theme_options_admins_bar_menu' ) ) {

  function ot_register_theme_options_admins_bar_menu( $wp_admin_bar ) {
    ...
    $wp_admin_bar->add_node( array(
      ...
      'title'   => apply_filters( 'ot_theme_options_page_title', esc_html__( 'Theme Options', 'coworking' ) ),
