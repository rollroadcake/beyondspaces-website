...
if ( ! class_exists( 'OT_Meta_Box' ) ) {
  ...
  class OT_Meta_Box {
    ...
    function __construct( $meta_box ) {
      ...
      coworking_action_add_metabox($this, 'ot_adds_meta_boxes');
     ...
     * @since     1.0
     */
    function ot_adds_meta_boxes() {
      foreach ( (array) $this->meta_box['pages'] as $page ) {
          coworking_add_metabox( $this->meta_box['id'], $this->meta_box['title'], array( $this, 'build_meta_box' ), $page, $this->meta_box['context'], $this->meta_box['priority'], $this->meta_box['fields'] );
      }
    }
