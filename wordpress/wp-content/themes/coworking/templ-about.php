            ...
            <div class="wrapper uni-clear">
                <div class="uni-fcell">
                    ...
                    if ( ! empty($top_image_id) ) {
                        ...
                        $top_image = '<img src="https://via.placeholder.com/570x270" alt="' . $placeholder_alt . '">';
                    }
                    ...
                    if ( ! empty($lb_image_id) ) {
                        ...
                        $lb_image = '<img src="https://via.placeholder.com/270x270" alt="' . $placeholder_alt . '">';
                    }
                    ...
                    if ( ! empty($rb_image_id) ) {
                        ...
                        $rb_image = '<img src="https://via.placeholder.com/270x270" alt="' . $placeholder_alt . '">';
                    }
                    ?>
            ...
            <div class="wrapper">
                ...
                foreach ( $oUserQuery->results as $oUser ) {
                    ...
                    if ( ! empty($avatar_attach_id) && get_post( $avatar_attach_id ) ) {
                        ...
                        $thumbnail_html = '<img class="uni-our-team-item-img" src="https://via.placeholder.com/270x270" alt="' . esc_attr( $oUser->display_name ) . '">';
                    }
                ?>
                    <?php
