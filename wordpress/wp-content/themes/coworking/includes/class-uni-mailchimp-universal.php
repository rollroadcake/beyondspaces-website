...
class Uni_Coworking_Theme_Mailchimp_Universal
{
     ...
     *  $aArgs : {array}
     */
    public function call_lists($sCallName = 'lists', $sMethod = false, $aArgs = array())
    {
     ...
     *  $aArgs : {array}
     */
    public function call_lists_interest_categories($sCallName = 'lists/interest-categories', $sMethod = false, $aArgs = array())
    {
     ...
     *  $aArgs : {array}
     */
    public function call_lists_members($sCallName = 'lists/members', $sMethod = false, $aArgs = array())
    {
