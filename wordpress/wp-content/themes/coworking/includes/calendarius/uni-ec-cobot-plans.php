...
<div class="uni-ec-cobot-plans-shortcode-wrapper <?php echo esc_attr( $sThemeClass ); ?>">
                ...
                <div class="uniPricingItem uni-clear">
                    <div class="scell">
                        ...
                        <div class="uniPricingItemPrice">
                            ...
                            <strong><?php echo wp_kses_post( $sPrice ); ?></strong>
                        ...
                        <?php echo wp_kses_post( $Parsedown->text($oPlan->description) ); ?>
