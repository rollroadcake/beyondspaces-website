...
function uni_coworking_theme_meta_boxes() {
  ...
  $event_meta_box_new = apply_filters('unitheme_event_meta_box_array', $event_meta_box );
  ...
  $events_meta_box_new = apply_filters('unitheme_events_meta_box_array', $events_meta_box );
...
array(
      ...
      array(
        'id'          => 'uni_contact_email_subject',
        'label'       => esc_html__( 'Custom subject for contact emails', 'coworking' ),
        'desc'        => '',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'contact',
  ...
  if ( function_exists( 'ot_register_meta_box' ) )
    ...
    ot_register_meta_box( $event_meta_box_new );
    ot_register_meta_box( $tickera_meta_box );
    ot_register_meta_box( $events_meta_box_new );
