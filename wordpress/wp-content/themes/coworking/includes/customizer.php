...
// Sanitaze image
function uni_coworking_sanitize_image( $input, $setting ) {
    return esc_url_raw( uni_coworking_validate_image( $input, $setting->default ) );
}
 ...
 */
function uni_coworking_validate_image( $input, $default = '' ) {
