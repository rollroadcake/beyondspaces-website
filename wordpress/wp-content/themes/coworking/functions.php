...
{
    echo '<li id="theme-version"><span>Coworking Co. WP Theme 1.1.10</span></li>';
}
...
function uni_coworking_theme_styles()
{
    ...
    if (!ot_get_option('uni_google_fonts') || empty($ot_set_google_fonts)) {
        wp_enqueue_style('uni-coworking-theme-fonts', uni_coworking_theme_fonts_url(), array(), '1.1.10');
    }
    ...
    wp_enqueue_style('uni-coworking-theme-adaptive', get_template_directory_uri() . '/css/adaptive.css', array('uni-coworking-theme-styles'), '1.1.10', 'screen');
}
...
function uni_coworking_theme_admin_script($hook)
{
    ...
    wp_enqueue_script('uni-coworking-theme-admin', get_template_directory_uri() . '/js/uni-admin.js', array('jquery'), '1.1.10');
            ...
            while ($oRelatedQuery->have_posts()) {
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class('postItem') ?>>
                    <a href="<?php the_permalink() ?>" class="postItemImg" title="<?php the_title_attribute() ?>">
                        ...
                        <?php } else { ?>
                            <img src="https://via.placeholder.com/370x250" width="370" height="250"
            ...
            while ($oRelatedQuery->have_posts()) {
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class('relatedPostItem') ?>>
                    <a class="postItemImg" href="<?php the_permalink() ?>">
                        ...
                        <?php } else { ?>
                            <img src="https://via.placeholder.com/260x173" width="260" height="173"
                                 alt="<?php the_title_attribute() ?>"/>
                        <?php } ?>
                    </a>
                    <div class="postItemMeta">
...
<li id="comment-<?php comment_ID(); ?>" <?php comment_class(empty($args['has_children']) ? '' : 'parent'); ?>>
        ...
        if (is_singular('product')) {
            ...
            if ((is_shop() || is_search()) && !empty($iShopAttachId)) {
                ...
                if ($aPageHeaderImage) {
                    ...
                    $sPageHeaderImage = 'https://via.placeholder.com/1920x600/a3d39c/fbfc91';
                }
            } else {
                $sPageHeaderImage = 'https://via.placeholder.com/1920x600/a3d39c/fbfc91';
            }
    ...
    //
    function uni_coworking_theme_woo_get_product_thumbnail($size = 'shop_catalog', $placeholder_width = 0, $placeholder_height = 0, $iPostId = false)
    {
