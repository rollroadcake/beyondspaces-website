	...
	<section class="uni-container">
                    ...
                    <li data-slide="<?php echo esc_attr( $i ); ?>" style="background-image: url(<?php if ( isset($aImage[0]) ) { echo esc_url( $aImage[0] ); } ?>);">
                        ...
                        <div class="screenDesc2">
                            ...
                            <?php if ( $aPostCustom['uni_slide_button_enable'][0] && $aPostCustom['uni_slide_button_enable'][0] === 'on' ) { ?>
                                ...
                                <span style="cursor:pointer;" data-href="<?php if ( $aPostCustom['uni_slide_button_custom_link_uri'][0] ) { echo esc_url( $aPostCustom['uni_slide_button_custom_link_uri'][0] ); } ?>" class="bookATourLink uni-home-slide-btn"><?php if ( $aPostCustom['uni_slide_button_label'][0] ) { echo esc_html( $aPostCustom['uni_slide_button_label'][0] ); } ?></span>
                                <?php } else { ?>
        ...
        <?php
            ...
            if ( !empty($iStaticImageBgAttachId) ) {
                ...
                $sStaticImageBgUrl = 'https://via.placeholder.com/1920x1600/5FC7AE/FFFFFF';
            }
        ?>
		...
		<div id="About" class="homeSlider uni-clear">
			...
			<div class="fcell">
                ...
                ?>
                    <li style="background-image: url(https://via.placeholder.com/1660x1600);"></li>
                    <li style="background-image: url(https://via.placeholder.com/1660x1600);"></li>
                <?php } ?>
				</ul>
			</div>
        ...
        <?php
            ...
            if ( !empty($iParallaxOneBgAttachId) ) {
                ...
                $sParallaxOneBgUrl = 'https://via.placeholder.com/1920x1600/5FC7AE/FFFFFF';
            }
        ?>
		...
		<div id="Pricing" class="pricingPlans">
            ...
            if ( ot_get_option( 'uni_home_price_tables_subscriptions_enable' ) == 'on' && class_exists('WC_Subscriptions_Product') ) {
                ...
                if ( !empty($iPriceItemBgAttachId) ) {
                    ...
                    $sPriceItemBgUrl = 'https://via.placeholder.com/370x94/000000/FFFFFF';
                }
                ...
                if ( !empty($iPriceItemBgAttachId) ) {
                    ...
                    $sPriceItemBgUrl = 'https://via.placeholder.com/370x94/';
                }
                ?>
    				<div class="pricingPlanItem">
    					<h3 style="background-image: url(<?php echo esc_url($sPriceItemBgUrl) ?>);"><?php the_title() ?></h3>
            ...
            <?php if ( ot_get_option( 'uni_home_price_tabels_plans_enable' ) === 'on' &&
                ...
                while ( $plans_query->have_posts() ) : $plans_query->the_post();
                    ...
                    if ( has_post_thumbnail( get_the_ID() ) ) {
                        ...
                        $sPriceItemBgUrl = '<img src="https://via.placeholder.com/370x94" alt="' . esc_attr( get_the_title( get_the_ID() ) ) . '">';
                    }
                ?>
        ...
        ?>
                <li style="background-image: url(https://via.placeholder.com/1920x600/);"><div class="eventSlideOverlay"></div></li>
        <?php
                }
            endwhile;
        endif;
